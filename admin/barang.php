...
<?php 
$per_hal=10;
$jumlah_record=mysqli_query($mysqli,"SELECT COUNT(*) from barang");
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysqli_query($mysqli,"select * from barang where nama like '$cari' or jenis like '$cari'");
	}else{
		$brg=mysqli_query($mysqli,"select * from barang limit $start, $per_hal");
	}
	$no=1;
