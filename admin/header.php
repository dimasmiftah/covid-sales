...
<body>
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">KIOS</a>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			<li class="<?php if($currentPage =='dashboard'){echo 'active';}?>"><a href="index.php"><span class="glyphicon glyphicon-home"></span>  Dashboard</a></li>			
			...
			<li class="<?php if($currentPage =='barang_laku'){echo 'active';}?>"><a href="barang_laku.php"><span class="glyphicon glyphicon-briefcase"></span>  Data Penjualan</a></li>        												
