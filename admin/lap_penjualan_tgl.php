...
$pdf->Image('../logo/textmoji-D.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'KIOS textmoji-D',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. KIOS textmoji-D',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.textmoji-D.com email : textmoji-D@gmail.com',0,'L');
...
$query=mysqli_query($mysqli,"select * from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
...
$q=mysqli_query($mysqli,"select sum(total_harga) as total from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
...
$qu=mysqli_query($mysqli,"select sum(laba) as total_laba from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
